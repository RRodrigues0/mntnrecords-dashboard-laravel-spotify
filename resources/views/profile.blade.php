        ...
        <div class="navigation">
          <nav>
            <ul>
              ...
              <li class="profile"><a class="active" href="/profile"><i class="fa fa-user"></i><span>Profile</span></a></li>
                  ...
                  <div class="box">
                    ...
                    <div class="row">
                      <div class="col-12 col-lg-6">
                        <label for="avatar">Picture <small>(only .jpg & .jpeg, max 2mb)</small></label>
                        <input id="avatar" type="file" name="avatar" accept=".jpg, .jpeg" required>
                      </div>
                      <div class="col-12">
                        <div class="flex">
                        ...
                        <div class="output">
                          @if($errors->has('avatarMessage'))
                            <div class="border-error">{{ $errors->first('avatarMessage') }}</div>
                          @endif
                      ...
                      <div class="col-12">
                        ...
                        <div class="output">
                          @if($errors->has('passwordMessage'))
                            <div class="border-error">{{ $errors->first('passwordMessage') }}</div>
                          @endif
                          @if(session()->has('passwordSuccess'))
                            <div class="border-success">{{ session('passwordSuccess') }}</div>
                          @endif
                        </div>
                      </div>
                    </div>
