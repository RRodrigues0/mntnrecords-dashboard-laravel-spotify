        ...
        <div class="navigation">
          <nav>
            <ul>
              ...
              <li class="releases"><a href="/releases"><i class="fa fa-music"></i><span>Releases</span></a></li>
              <li class="payout"><a class="active" href="/payout"><i class="fa fa-money-check"></i><span>Payout</span></a></li>
                  ...
                  <div class="box">
                    ...
                    <div class="row">
                      <div class="col-12 col-lg-6">
                        ...
                        <input id="paypal" required="true" type="text" name="paypal" value="{!! $user['email'] !!}">
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="money">Payout amount <small>(minimum 5€)</small></label>
                        <input name="money" required="true" type="number" min="0" max="{!! $balance !!}" step="0.01" value="{!! $balance !!}" id="money">
                      </div>
                      <div class="col-12">
                        <label for="accept">
                          <input type="checkbox" id="accept" name="accept" required="true">
                          I agree that any PayPal fees incurred will be deducted from the amount requested.
                        </label>
                        <div class="flex">
                        ...
                        <div class="output">
                          @if($errors->has('payoutMessage'))
                            <div class="border-error">{{ $errors->first('payoutMessage') }}</div>
                          @endif
